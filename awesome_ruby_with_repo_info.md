...
-   [Responders](https://github.com/plataformatec/responders) <span> ★ 1367, pushed 9 days ago </span> - A set of Rails responders to dry up your application.
...
-   [Action caching for Action Pack](https://github.com/rails/actionpack-action_caching) <span> ★ 92, pushed 18 days ago </span> - Action caching for Action Pack.
...
-   [AWS SDK for Ruby](https://github.com/aws/aws-sdk-ruby) <span> ★ 2003, pushed 4 days ago </span> - The official AWS SDK for Ruby.
...
-   [Scientist](https://github.com/github/scientist) <span> ★ 3443, pushed 3 days ago </span> - A Ruby library for carefully refactoring critical paths.
...
-   [SchemaPlus](https://github.com/SchemaPlus/schema_plus) <span> ★ 617, pushed 32 days ago </span> - SchemaPlus provides a collection of enhancements and extensions to ActiveRecord
...
-   [auto\_html](https://github.com/dejan/auto_html) <span> ★ 712, pushed 123 days ago </span> - Rails extension for transforming URLs to appropriate resource (image, link, YouTube, Vimeo video...)
...
-   Import
    ...
    -   [ferry](https://github.com/cmu-is-projects/ferry) <span> ★ 254, pushed 79 days ago </span> - A ruby gem for easy data transfer.
-   Misc
...
-   [SciRuby](https://github.com/sciruby/sciruby) <span> ★ 736, pushed 86 days ago </span> - Tools for scientific computation in Ruby/Rails.
    ...
    -   [statsample-glm](https://github.com/sciruby/statsample-glm) <span> ★ 8, pushed 250 days ago </span> - Generalized Linear Models extension for Statsample.
...
-   [Mongoid Search](https://github.com/mauriciozaffari/mongoid_search) <span> ★ 257, pushed 132 days ago </span> - Simple full text search implementation for Mongoid.
-   [pg\_search](https://github.com/Casecommons/pg_search) <span> ★ 1484, pushed 7 days ago </span> - Builds ActiveRecord named scopes that take advantage of PostgreSQL's full text search.
-   [ransack](https://github.com/activerecord-hackery/ransack/) - Object-based searching.
-   [Rroonga](https://github.com/ranguba/rroonga) <span> ★ 46, pushed 3 days ago </span> - The Ruby bindings of Groonga.
-   [SearchCop](https://github.com/mrkamel/search_cop) <span> ★ 397, pushed 86 days ago </span> - Extends your ActiveRecord models to support fulltext search engine like queries via simple query strings and hash-based queries.
-   [Searchkick](https://github.com/ankane/searchkick) <span> ★ 2735, pushed 1 days ago </span> - Searchkick learns what your users are looking for. As more people search, it gets smarter and the results get better. It’s friendly for developers - and magical for your users.
-   [Searchlogic](https://github.com/binarylogic/searchlogic) <span> ★ 1405, pushed 600 days ago </span> - Object based searching, common named scopes, and other useful named scope tools for ActiveRecord.
-   [Sunspot](https://github.com/sunspot/sunspot) <span> ★ 2536, pushed 12 days ago </span> - A Ruby library for expressive, powerful interaction with the Solr search engine.
-   [textacular](https://github.com/textacular/textacular) <span> ★ 458, pushed 138 days ago </span> - Exposes full text search capabilities from PostgreSQL, and allows you to declare full text indexes. Textacular extends ActiveRecord with named\_scope methods making searching easy and fun!
-   [Thinking Sphinx](https://github.com/pat/thinking-sphinx) <span> ★ 1465, pushed 30 days ago </span> - A library for connecting ActiveRecord to the Sphinx full-text search tool.

Security
--------

-   [bundler-audit](https://github.com/rubysec/bundler-audit) <span> ★ 1094, pushed 10 days ago </span> - Patch-level security verification for Bundler.
-   [Gitrob](https://github.com/michenriksen/gitrob) <span> ★ 1222, pushed 5 days ago </span> - Reconnaissance tool for GitHub organizations.
-   [Metasploit](https://github.com/rapid7/metasploit-framework) <span> ★ 5616, pushed 0 days ago </span> - World's most used penetration testing software.
-   [Rack::Attack](https://github.com/kickstarter/rack-attack) <span> ★ 2517, pushed 31 days ago </span> - Rack middleware for blocking & throttling abusive requests.
-   [Rack::Protection](https://github.com/sinatra/rack-protection) <span> ★ 837, pushed 90 days ago </span> - Rack middleware for protecting against typical Web attacks.
-   [RbNaCl](https://github.com/cryptosphere/rbnacl) <span> ★ 491, pushed 5 days ago </span> - Ruby binding to the Networking and Cryptography (NaCl) library.
-   [SecureHeaders](https://github.com/twitter/secureheaders) <span> ★ 1664, pushed 0 days ago </span> - Automatically apply several headers that are related to security, including: Content Security Policy (CSP), HTTP Strict Transport Security (HSTS), X-Frame-Options (XFO), X-XSS-Protection, X-Content-Type-Options, X-Download-Options & X-Permitted-Cross-Domain-Policies.

SEO
---

-   [FriendlyId](https://github.com/norman/friendly_id) <span> ★ 4037, pushed 51 days ago </span> - The "Swiss Army bulldozer" of slugging and permalink plugins for Active Record.
-   [MetaTags](https://github.com/kpumuk/meta-tags) <span> ★ 1276, pushed 41 days ago </span> - A gem to make your Rails application SEO-friendly.
-   [prerender\_rails](https://github.com/prerender/prerender_rails) <span> ★ 255, pushed 68 days ago </span> - Rails middleware gem for prerendering javascript-rendered pages on the fly for SEO.
-   [SitemapGenerator](https://github.com/kjvarga/sitemap_generator) <span> ★ 1490, pushed 13 days ago </span> - A framework-agnostic XML Sitemap generator written in Ruby.

Social Networking
-----------------

-   [diaspora\*](https://github.com/diaspora/diaspora) <span> ★ 10670, pushed 0 days ago </span> - A privacy aware, distributed, open source social network.
-   [Discourse](https://github.com/discourse/discourse) <span> ★ 18008, pushed 0 days ago </span> - A platform for community discussion. Free, open, simple.
-   [Forem](https://github.com/radar/forem) - Rails 3 and Rails 4 forum engine.
-   [Mailboxer](https://github.com/mailboxer/mailboxer) <span> ★ 1277, pushed 8 days ago </span> - A private message system for Rails applications.
-   [Social Shares](https://github.com/Timrael/social_shares) <span> ★ 239, pushed 15 days ago </span> - A gem to check how many times url was shared in social networks.

Spreadsheets and Documents
--------------------------

-   [AXLSX](https://github.com/randym/axlsx) <span> ★ 1603, pushed 1 days ago </span> - An excel xlsx generation library.
...
-   [Roo](https://github.com/roo-rb/roo) <span> ★ 1288, pushed 10 days ago </span> - Implements read access for all spreadsheet types and read/write access for Google spreadsheets.
-   [Yomu](https://github.com/Erol/yomu) <span> ★ 293, pushed 145 days ago </span> - Read text and metadata from files and documents (.doc, .docx, .pages, .odt, .rtf, .pdf).

State Machines
--------------

-   [AASM](https://github.com/aasm/aasm) <span> ★ 2339, pushed 7 days ago </span> - State machines for Ruby classes (plain Ruby, Rails Active Record, Mongoid).
...
-   [Statesman](https://github.com/gocardless/statesman) <span> ★ 718, pushed 27 days ago </span> - A statesmanlike state machine library.
-   [transitions](https://github.com/troessner/transitions) <span> ★ 472, pushed 6 days ago </span> - A ruby state machine implementation.
-   [Workflow](https://github.com/geekq/workflow) <span> ★ 1279, pushed 6 days ago </span> - A finite-state-machine-inspired API for modeling and interacting with what we tend to refer to as 'workflow'.

Static Site Generation
----------------------

-   [High Voltage](https://github.com/thoughtbot/high_voltage) <span> ★ 2296, pushed 4 days ago </span> - Easily include static pages in your Rails app.
-   [Jekyll](http://jekyllrb.com) - Transform your plain text into static websites and blogs.
    -   [Awesome Jekyll](https://github.com/planetjekyll/awesome-jekyll) <span> ★ 170, pushed 4 days ago </span> - A collection of awesome Jekyll tools, plugins, themes, guides and much more.
...
-   [Octopress](https://github.com/octopress/octopress) <span> ★ 1353, pushed 77 days ago </span> - Octopress is an obsessively designed toolkit for writing and deploying Jekyll blogs.
-   [Photish](https://github.com/henrylawson/photish) <span> ★ 102, pushed 90 days ago </span> - Generate a highly configurable static website from a photo collection.
-   [webgen](http://webgen.gettalong.org) - webgen is a fast, powerful and extensible static website generator.

Template Engine
---------------

-   [Curly](https://github.com/zendesk/curly) <span> ★ 549, pushed 89 days ago </span> - A template language that completely separates structure and logic.
-   [Haml](https://github.com/haml/haml) <span> ★ 2936, pushed 60 days ago </span> - HTML Abstraction Markup Language.
-   [Liquid](https://github.com/Shopify/liquid) <span> ★ 4408, pushed 0 days ago </span> - Safe, customer facing template language for flexible web apps.
-   [Mustache](https://github.com/mustache/mustache) <span> ★ 2179, pushed 32 days ago </span> - Logic-less Ruby templates.
-   [Slim](https://github.com/slim-template/slim) <span> ★ 3886, pushed 15 days ago </span> - A template language whose goal is reduce the syntax to the essential parts without becoming cryptic.
-   [Tilt](https://github.com/rtomayko/tilt) <span> ★ 1555, pushed 14 days ago </span> - Generic interface to multiple Ruby template engines.

Testing
-------

-   Frameworks
    -   [RSpec](https://github.com/rspec/rspec) <span> ★ 1540, pushed 23 days ago </span> - Behaviour Driven Development for Ruby.
    -   Formatters
        -   [Emoji-RSpec](https://github.com/cupakromer/emoji-rspec) <span> ★ 163, pushed 862 days ago </span> - Custom Emoji Formatters for RSpec.
        -   [Fuubar](https://github.com/thekompanee/fuubar) <span> ★ 627, pushed 0 days ago </span> - The instafailing RSpec progress bar formatter.
        -   [Nyan Cat](https://github.com/mattsears/nyan-cat-formatter) <span> ★ 566, pushed 385 days ago </span> - Nyan Cat inspired RSpec formatter!
    -   [Aruba](https://github.com/cucumber/aruba) <span> ★ 696, pushed 5 days ago </span> - Testing command line applications with cucumber and rspec.
    -   [Bacon](https://github.com/chneukirchen/bacon) <span> ★ 385, pushed 258 days ago </span> - A small RSpec clone.
    -   [Capybara](http://jnicklas.github.io/capybara) - Acceptance test framework for web applications.
    -   [Cucumber](https://github.com/cucumber/cucumber) <span> ★ 342, pushed 10 days ago </span> - BDD that talks to domain experts first and code second.
    -   [Cutest](https://github.com/djanowski/cutest) <span> ★ 133, pushed 143 days ago </span> - Isolated tests in Ruby.
    -   [Howitzer](https://github.com/strongqa/howitzer) <span> ★ 123, pushed 82 days ago </span> - Ruby based framework for acceptance testing
    -   [Konacha](https://github.com/jfirebaugh/konacha) <span> ★ 1026, pushed 17 days ago </span> - Test your Rails application's JavaScript with the mocha test framework and chai assertion library.
    -   [minitest](https://github.com/seattlerb/minitest) <span> ★ 1853, pushed 0 days ago </span> - minitest provides a complete suite of testing facilities supporting TDD, BDD, mocking, and benchmarking.
    -   [RR](https://github.com/rr/rr) <span> ★ 217, pushed 74 days ago </span> - A test double framework that features a rich selection of double techniques and a terse syntax.
    -   [shoulda-matchers](https://github.com/thoughtbot/shoulda-matchers) <span> ★ 1638, pushed 5 days ago </span> - Provides Test::Unit- and RSpec-compatible one-liners that test common Rails functionality. These tests would otherwise be much longer, more complex, and error-prone.
    -   [Spinach](https://github.com/codegram/spinach) <span> ★ 483, pushed 26 days ago </span> - Spinach is a high-level BDD framework that leverages the expressive Gherkin language (used by Cucumber) to help you define executable specifications of your application or library's acceptance criteria.
    -   [Spork](https://github.com/sporkrb/spork) <span> ★ 1402, pushed 21 days ago </span> - A DRb server for testing frameworks (RSpec / Cucumber currently).
...
-   Fake Data
    ...
    -   [factory\_girl](https://github.com/thoughtbot/factory_girl) <span> ★ 4716, pushed 2 days ago </span> - A library for setting up Ruby objects as test data.
    -   [Fake Person](https://github.com/adamcooke/fake-person) <span> ★ 114, pushed 554 days ago </span> - Uses some of the most popular given & surnames in the US & UK.
    -   [faker](https://github.com/stympy/faker) <span> ★ 3731, pushed 0 days ago </span> - A library for generating fake data such as names, addresses, and phone numbers.
    -   [ffaker](https://github.com/ffaker/ffaker) <span> ★ 968, pushed 0 days ago </span> - A faster Faker, generates dummy data, rewrite of faker.
    -   [Forgery](https://github.com/sevenwire/forgery) <span> ★ 719, pushed 354 days ago </span> - Easy and customizable generation of forged data.
    -   [Machinist](https://github.com/notahat/machinist) <span> ★ 1133, pushed 995 days ago </span> - Fixtures aren't fun. Machinist is.
-   Mock
    -   [ActiveMocker](https://github.com/zeisler/active_mocker) <span> ★ 291, pushed 32 days ago </span> - Generate mocks from ActiveRecord models for unit tests that run fast because they don’t need to load Rails or a database.
    -   [DuckRails](https://github.com/iridakos/duckrails) <span> ★ 711, pushed 4 days ago </span> - Tool for mocking API endpoints quickly & dynamically.
    -   [TestXml](https://github.com/alovak/test_xml) <span> ★ 25, pushed 401 days ago </span> - TestXml is a small extension for testing XML/HTML.
    -   [WebMock](https://github.com/bblimke/webmock) <span> ★ 2145, pushed 0 days ago </span> - Library for stubbing and setting expectations on HTTP requests.
-   WebDrivers
    -   [Selenium WebDriver](http://selenium.googlecode.com/git/docs/api/rb/index.html) - This gem provides Ruby bindings for WebDriver.
    -   [API Taster](https://github.com/fredwu/api_taster) <span> ★ 723, pushed 402 days ago </span> - A quick and easy way to visually test your Rails application's API.
    -   [Poltergeist](https://github.com/teampoltergeist/poltergeist) <span> ★ 2091, pushed 6 days ago </span> - A PhantomJS driver for Capybara.
    -   [Watir](https://github.com/watir/watir/) - Web application testing in Ruby.
-   Extra
    -   [Appraisal](https://github.com/thoughtbot/appraisal) <span> ★ 647, pushed 35 days ago </span> - Appraisal integrates with bundler and rake to test your library against different versions of dependencies.
    -   [mutant](https://github.com/mbj/mutant) <span> ★ 1075, pushed 0 days ago </span> - Mutant is a mutation testing tool for Ruby.
    -   [Parallel Tests](https://github.com/grosser/parallel_tests) <span> ★ 1731, pushed 5 days ago </span> - Speedup Test::Unit + RSpec + Cucumber by running parallel on multiple CPUs (or cores).
    -   [Ruby-JMeter](https://github.com/flood-io/ruby-jmeter) <span> ★ 424, pushed 122 days ago </span> - A Ruby based DSL for building JMeter test plans.
    -   [Spring](https://github.com/rails/spring) <span> ★ 2105, pushed 13 days ago </span> - Preloads your rails environment in the background for faster testing and Rake tasks.
    -   [timecop](https://github.com/travisjeffery/timecop) <span> ★ 2048, pushed 17 days ago </span> - Provides "time travel" and "time freezing" capabilities, making it dead simple to test time-dependent code.
    -   [vcr](https://github.com/vcr/vcr) <span> ★ 2916, pushed 4 days ago </span> - Record your test suite's HTTP interactions and replay them during future test runs for fast, deterministic, accurate tests.
    -   [Zapata](https://github.com/Nedomas/zapata) <span> ★ 347, pushed 194 days ago </span> - Who has time to write tests? This is a revolutionary tool to make them write themselves.
    -   [Wrong](https://github.com/sconover/wrong) <span> ★ 409, pushed 186 days ago </span> - Wrong provides a general assert method that takes a predicate block. Assertion failure messages are rich in detail.

Third-party APIs
----------------

-   [databasedotcom](https://github.com/heroku/databasedotcom) <span> ★ 332, pushed 48 days ago </span> - Ruby client for the Salesforce's Database.com and Chatter APIs.
-   [Dropbox](https://github.com/futuresimple/dropbox-api) <span> ★ 347, pushed 147 days ago </span> - Dropbox API Ruby Client.
-   [facy](https://github.com/huydx/facy) <span> ★ 210, pushed 146 days ago </span> - Command line power tool for facebook.
-   [fb\_graph](https://github.com/nov/fb_graph) <span> ★ 1091, pushed 109 days ago </span> - A full-stack Facebook Graph API wrapper.
-   [flickr](https://github.com/RaVbaker/flickr) <span> ★ 17, pushed 666 days ago </span> - A Ruby interface to the Flickr API.
-   [gitlab](https://github.com/NARKOZ/gitlab) <span> ★ 282, pushed 0 days ago </span> - Ruby wrapper and CLI for the GitLab API.
-   [gmail](https://github.com/gmailgem/gmail) <span> ★ 172, pushed 14 days ago </span> - A Rubyesque interface to Gmail, with all the tools you'll need.
-   [hipchat-rb](https://github.com/hipchat/hipchat-rb) <span> ★ 321, pushed 42 days ago </span> - HipChat HTTP API Wrapper in Ruby with Capistrano hooks.
-   [instagram-ruby-gem](https://github.com/Instagram/instagram-ruby-gem) - The official gem for the Instagram REST and Search APIs.
-   [itunes *store* transporter](https://github.com/sshaw/itunes_store_transporter) <span> ★ 87, pushed 65 days ago </span> - Ruby wrapper around Apple's iTMSTransporter program.
-   [linkedin](https://github.com/hexgnu/linkedin) <span> ★ 698, pushed 89 days ago </span> - Provides an easy-to-use wrapper for LinkedIn's REST APIs.
-   [Octokit](http://octokit.github.io/octokit.rb) - Ruby toolkit for the GitHub API.
-   [Pusher](https://github.com/pusher/pusher-http-ruby) <span> ★ 506, pushed 63 days ago </span> - Ruby server library for the Pusher API.
-   [ruby-gmail](https://github.com/dcparker/ruby-gmail) <span> ★ 739, pushed 280 days ago </span> - A Rubyesque interface to Gmail.
-   [ruby-trello](https://github.com/jeremytregunna/ruby-trello) <span> ★ 523, pushed 11 days ago </span> - Implementation of the Trello API for Ruby.
-   [simple-slack-bot](https://github.com/kciter/simple-slack-bot) <span> ★ 141, pushed 65 days ago </span> - You can easily make Slack Bot.
-   [Slack Notifier](https://github.com/stevenosloan/slack-notifier) <span> ★ 609, pushed 10 days ago </span> - A simple wrapper for posting to Slack channels.
-   [Slack ruby gem](https://github.com/aki017/slack-ruby-gem) <span> ★ 142, pushed 56 days ago </span> - A Ruby wrapper for the Slack API.
-   [soundcloud-ruby](https://github.com/soundcloud/soundcloud-ruby) <span> ★ 290, pushed 206 days ago </span> - Official SoundCloud API Wrapper for Ruby.
-   [t](https://github.com/sferik/t) <span> ★ 3705, pushed 4 days ago </span> - A command-line power tool for Twitter.
-   [tweetstream](https://github.com/tweetstream/tweetstream) <span> ★ 1075, pushed 84 days ago </span> - A simple library for consuming Twitter's Streaming API.
-   [twilio-ruby](https://github.com/twilio/twilio-ruby) <span> ★ 849, pushed 12 days ago </span> - A module for using the Twilio REST API and generating valid TwiML.
-   [twitter](https://github.com/sferik/twitter) <span> ★ 3549, pushed 24 days ago </span> - A Ruby interface to the Twitter API.
-   [wikipedia](https://github.com/kenpratt/wikipedia-client) <span> ★ 154, pushed 4 days ago </span> - Ruby client for the Wikipedia API.
-   [Yt](https://github.com/Fullscreen/yt) <span> ★ 404, pushed 5 days ago </span> - An object-oriented Ruby client for YouTube API V3.

Video
-----

-   [Streamio FFMPEG](https://github.com/streamio/streamio-ffmpeg) <span> ★ 940, pushed 5 days ago </span> - Simple yet powerful wrapper around the ffmpeg command for reading metadata and transcoding movies.

Web Crawling
------------

-   [anemone](https://github.com/chriskite/anemone) <span> ★ 1486, pushed 98 days ago </span> - Ruby library and CLI for crawling websites.
-   [LinkThumbnailer](https://github.com/gottfrois/link_thumbnailer) <span> ★ 296, pushed 7 days ago </span> - Ruby gem that generates thumbnail images and videos from a given URL. Much like popular social website with link preview.
-   [Mechanize](https://github.com/sparklemotion/mechanize) <span> ★ 2955, pushed 8 days ago </span> - Mechanize is a ruby library that makes automated web interaction easy.
-   [MetaInspector](https://github.com/jaimeiniesta/metainspector) <span> ★ 618, pushed 0 days ago </span> - Ruby gem for web scraping purposes.
-   [Upton](https://github.com/propublica/upton) <span> ★ 1481, pushed 158 days ago </span> - A batteries-included framework for easy web-scraping.
-   [Wombat](https://github.com/felipecsl/wombat) <span> ★ 781, pushed 25 days ago </span> - Web scraper with an elegant DSL that parses structured data from web pages.
...
-   [Hobbit](https://github.com/patriciomacadden/hobbit) <span> ★ 246, pushed 65 days ago </span> - A minimalistic microframework built on top of Rack.
...
-   [Volt](https://github.com/voltrb/volt) <span> ★ 3224, pushed 28 days ago </span> - A Ruby web framework where your ruby code runs on both the server and the client.

Web Servers
-----------

-   [Goliath](https://github.com/postrank-labs/goliath) <span> ★ 2318, pushed 73 days ago </span> - A non-blocking Ruby web server framework.
-   [Phusion Passenger](https://www.phusionpassenger.com) - Fast and robust web server and application server.
-   [Puma](https://github.com/puma/puma) <span> ★ 4062, pushed 2 days ago </span> - A modern, concurrent web server for Ruby.
...
-   [Reel](https://github.com/celluloid/reel) <span> ★ 581, pushed 32 days ago </span> - Celluloid::IO-powered web server.
-   [Thin](http://code.macournoyer.com/thin) - Tiny, fast & funny HTTP server.
-   [TorqueBox](https://github.com/torquebox/torquebox) <span> ★ 462, pushed 0 days ago </span> - A Ruby application server built on JBoss AS7 and JRuby.
...
-   [Firehose](https://github.com/firehoseio/firehose) <span> ★ 620, pushed 34 days ago </span> - Build realtime Ruby web applications.
-   [Rails Realtime](https://github.com/liamks/rails-realtime) <span> ★ 104, pushed 1076 days ago </span> - Adding Real-Time To Your RESTful Rails App.
-   [Slanger](https://github.com/stevegraham/slanger) <span> ★ 1399, pushed 41 days ago </span> - Open Pusher implementation compatible with Pusher libraries.
-   [Sync](https://github.com/chrismccord/sync) <span> ★ 1277, pushed 62 days ago </span> - Real-time Rails Partials.
-   [Websocket-Rails](https://github.com/websocket-rails/websocket-rails) <span> ★ 1521, pushed 8 days ago </span> - Creates a built in WebSocket server inside a Rails application with ease, and also support streaming HTTP.
...
-   [Ruby Bookmarks](https://github.com/dreikanter/ruby-bookmarks) <span> ★ 1107, pushed 3 days ago </span> - Ruby and Ruby on Rails bookmarks collection.
