...
* [smarter_csv](https://github.com/tilo/smarter_csv) - Ingest CSV files into hashes with automatic header handling, type conversion, clean-up, and protection against Ruby CSV's silent data corruption. Also exports CSV.
