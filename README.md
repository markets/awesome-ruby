...
* [rack-time-zone-middleware](https://github.com/merqlove/rack-time-zone-middleware) - Middleware which is helpful in use case of detecting timezone at UI side and its getting within Rack/Rails app via cookies.
