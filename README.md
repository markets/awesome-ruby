...
* [oauth_token_verifier](https://github.com/Shkrt/oauth_token_verifier) - A simple abstraction library for validating OAuth access tokens obtained from third party.
* OAuth:
