...
* [Passages](https://github.com/yez/passages) - Ruby on Rails Engine for routes inspection and search.
...
* Misc
  ...
  * [validates_type](https://github.com/yez/validates_type) - ActiveModel::Validations compliant type validator.
* Multi-tenancy
