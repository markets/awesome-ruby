...
* [Mathematica Language Library](https://github.com/nakilon/mll/) - module and core classes extension to make operations on basic data structures easier, similar to Wolfram Language
